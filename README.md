...
- **[Angular Frontend UI](https://github.com/dlokman/Angular-22-Project-With-Cognito)** — FrontEnd UI for both RestaurantAgent & FlightBooking utilizing Angular 22, TailwindCSS, Copilotkit, Angular Auth OIDC Client & AWS Managed Login via Cognito
